...
\begin{itemize}
  \item Unblocked the launch of a new collapsed ads service by designing a cAST-based gflag tracing tool that reduced memory usage by 7GB and fixed revenue regressions.
  \item Wrote claude skills to automate identification and clearing unused memory which reduced our ad memory usage by 3GB.
  \item Introduced a country-based sharding strategy for the ad retrieval service which reduced memory usage by 5GB.
  \item Implemented efficient memory shedding strategy reducing OOMs under load by $\sim$90\% improving availability in Q4 2024.
  \item Designed a C++ compile-time flag to switch service data model based on build type which resulted in 3GB of memory savings.
