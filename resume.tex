...
\textit{Teaching Assistant:} 17323/17623 Quality Assurance (Fall 2020)\\
\textit{Coursework:} Distributed Systems, DevOps, Engineering Data Intensive Scalable Systems, Architecture for Software Systems, Introduction to Machine Learning, Analysis of Software Artifacts, Introduction to Computer Systems.\\
\rule{0pt}{3ex}
...
\noindent
\\
\textbf{GoDaddy Inc.} | {\small Intern --- Software Development Engineer} \hfill \textit{Kirkland, WA (Remote)} | \textit{\small May 2020 - August 2020}
\begin{itemize}
...
\end{itemize}
\rule{0pt}{3ex}
\textbf{Zoho Corporation} | {\small Member Technical Staff} \hfill \textit{Chennai, India} | \textit{\small June 2018 - May 2019}
\begin{itemize}
...
\end{itemize}
\rule{0pt}{3ex}
\textbf{Zoho Corporation} | {\small Project Trainee} \hfill \textit{Chennai, India} | \textit{\small December 2017 - March 2018}
\begin{itemize}
...
\end{itemize}
\rule{0pt}{3ex}
\textbf{Tata Consultancy Services} | {\small Project Intern} \hfill \textit{Chennai, India} | \textit{\small June 2017 - July 2017}
\begin{itemize}
...
\textbf{Languages:} Java, Python, Javascript, C, Bash, Go. \textbf{Frontend:} Angular, JQuery, SCSS, HTML, CSS.
\end{document}