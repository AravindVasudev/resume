...
\domain{https://aravindvasudev.github.io/about/}{aravindvasudev.github.io}
...
{\small Software Engineer IV} \hfill \textit{\small April 2024 - Present}
\begin{itemize}
  \item Unblocked the launch of a new collapsed ads service by designing a cAST-based gflag tracing tool that reduced memory usage by 7GB (10.9\%) and fixed revenue regressions.
  \item Wrote claude skills to automate identification and clearing unused memory which reduced memory usage by 3GB (4.7\%).
  \item Introduced a country-based sharding strategy for the ad retrieval service which reduced memory usage by 5GB (7.8\%).
  \item Implemented efficient memory shedding strategy reducing OOMs under load by $\sim$90\% improving availability in Q4 2024.
  \item Created a new leaner service-specific ad data model which reduced ad retrieval memory cost by 3GB (4.7\%).
  \item Offset field cleanup flow from online to offline service which reduced our network cost by 8.1\%.
\end{itemize}
...
\noindent
\\
\textbf{Programming Languages:} C++, Python, Javascript/Typescript, Java, SQL, Bash, Go. \\
\textbf{Web:} React, Thrift, Protobuf, RPC, Spring, Flask, Angular, Structs. \\
