...
\begin{itemize}
  \item Conducting office hours for students to help them with the course content/projects, and evaluating the project submissions.
\end{itemize}
...
\begin{itemize}
  ...
  \item Designed the protocol to be connection-oriented and support client-server model natively.
